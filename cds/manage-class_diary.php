                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-25">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT distinct  class_diary_tbl.cd_id,class_diary_tbl.day,class_diary_tbl.dat,class_diary_tbl.activity,class_diary_tbl.toc,class_diary_tbl.commdesc,modules_tbl.mo_title,class_diary_tbl.lect_id,lecture_tbl.lect_name,class_diary_tbl.mo_id from class_diary_tbl join modules_tbl on class_diary_tbl.mo_id=modules_tbl.mo_id join lecture_tbl on lecture_tbl.lect_id=class_diary_tbl.lect_id";
